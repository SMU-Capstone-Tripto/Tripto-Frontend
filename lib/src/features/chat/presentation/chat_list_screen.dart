              ...
              children: [
                Row(
                  ...
                  children: [
                    PopupMenuButton<String>(
                      ...
                      itemBuilder: (context) => [
                        PopupMenuItem(
                          ...
                          child: Container(
                            ...
                            child: const Text(
                              '채팅방 정렬', 
                              style: TextStyle(color: Color(0xFF666666), fontSize: 10, fontFamily: 'Pretendard', fontWeight: FontWeight.w600) // 프리텐다드
                            ),
                          ),
                        ),
                        PopupMenuWidget(
                      ...
                      child: Row(
                        children: [
                          Text('채팅 ($_sortType)', style: const TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.w800, fontFamily: 'Pretendard', letterSpacing: 0.5)), // 프리텐다드
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    style: const TextStyle(color: Colors.black, fontSize: 15, fontFamily: 'Pretendard'), // 프리텐다드
                    decoration: InputDecoration(
                      hintText: '채팅방 검색',
                      hintStyle: const TextStyle(color: Color(0xFFB3B3B3), fontSize: 15, fontFamily: 'Pretendard'), // 프리텐다드
                      ...
                      suffixIcon: _searchQuery.isNotEmpty 
                        ? GestureDetector(
                            ...
                            child: const Icon(Icons.cancel, color: Color(0xFFB3B3B3), size: 18),
                          )
                        : null,
            ...
            child: filteredRooms.isEmpty
                ? Center(
                    child: Text(
                      ...
                      style: const TextStyle(color: Color(0xFF9CA3AF), fontSize: 14, fontFamily: 'Pretendard'), // 프리텐다드
                    ),
                  )
                : ListView.builder(
                    padding: EdgeInsets.zero,
    ...
    return Container(
      ...
      child: ListTile(
        ...
        leading: CircleAvatar(
          radius: 26,
          backgroundColor: isBot ? const Color(0xFF8055FF) : const Color(0xFFE5E7EB),
          child: isBot 
        ...
        title: Row(
          children: [
            Expanded(
              child: Text(
                title,
                style: const TextStyle(color: Colors.black, fontWeight: FontWeight.w600, fontSize: 16, fontFamily: 'Pretendard', letterSpacing: -0.5), // 프리텐다드
                maxLines: 1,
            ...
            if (!isBot)
              const Text('4', style: TextStyle(color: Color(0xFF9CA3AF), fontSize: 14, fontWeight: FontWeight.w400, fontFamily: 'Pretendard')), // 프리텐다드
          ],
        ),
        subtitle: Padding(
          ...
          child: Text(
            lastMsg,
            style: const TextStyle(color: Color(0xFF4B5563), fontSize: 13, fontFamily: 'Pretendard'), // 프리텐다드
            maxLines: 1,
            overflow: TextOverflow.ellipsis,
          ),
        ),
        trailing: Column(
          ...
          children: [
            Text(time, style: const TextStyle(color: Color(0xFF9CA3AF), fontSize: 12, fontFamily: 'Pretendard')), // 프리텐다드
            ...
            if (badgeCount > 0)
              Container(
                ...
                child: Text(
                  '$badgeCount',
                  style: const TextStyle(color: Colors.white, fontSize: 11, fontWeight: FontWeight.w900, fontFamily: 'Pretendard'), // 프리텐다드
                ),
              ),
          ],
        ),
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            Icon(Icons.check, size: 12, color: isSelected ? const Color(0xFF6241D9) : Colors.transparent),
            const SizedBox(width: 6),
            Text(
              widget.label,
              style: TextStyle(
